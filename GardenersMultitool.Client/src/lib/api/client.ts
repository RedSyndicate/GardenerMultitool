...
export class HardinessZone implements IHardinessZone {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            (<any>this).notKnown = _data["notKnown"];
        }
    }
...
export class HardinessZoneRange implements IHardinessZoneRange {
    maximumHardinessZone?: HardinessZone;
    minimumHardinessZone?: HardinessZone;

    constructor(data?: IHardinessZoneRange) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.maximumHardinessZone = _data["maximumHardinessZone"] ? HardinessZone.fromJS(_data["maximumHardinessZone"]) : <any>undefined;
            this.minimumHardinessZone = _data["minimumHardinessZone"] ? HardinessZone.fromJS(_data["minimumHardinessZone"]) : <any>undefined;
        }
    }

    static fromJS(data: any): HardinessZoneRange {
        data = typeof data === 'object' ? data : {};
        let result = new HardinessZoneRange();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["maximumHardinessZone"] = this.maximumHardinessZone ? this.maximumHardinessZone.toJSON() : <any>undefined;
        data["minimumHardinessZone"] = this.minimumHardinessZone ? this.minimumHardinessZone.toJSON() : <any>undefined;
        return data;
    }
}

export interface IHardinessZoneRange {
    maximumHardinessZone?: HardinessZone;
    minimumHardinessZone?: HardinessZone;
}
...
export class Plant implements IPlant {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hardinessZone = _data["hardinessZone"] ? HardinessZoneRange.fromJS(_data["hardinessZone"]) : <any>undefined;
...
export class CreateNewLocation implements ICreateNewLocation {
    name?: string | undefined;
    hardinessZone?: number;

    constructor(data?: ICreateNewLocation) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateNewLocation {
        data = typeof data === 'object' ? data : {};
        let result = new CreateNewLocation();
        result.init(data);
        return result;
    }
...
export interface ICreateNewLocation {
    name?: string | undefined;
    hardinessZone?: number;
}
